...
export default function FeederRegistration() {
  ...
  const handleChange = (e) => {
    ...
    if (error && name !== 'phone' && name !== 'address' && name !== 'capacity') {
      setError('');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createDonor(registrationData);
      setSuccess(true);
      setForm({ name: '', email: '', password: '', confirmPassword: '', phone: '', address: '', capacity: '' });
      setFieldErrors({});
      setError('');
  ...
  const isFormValid = () => {
    return form.name.trim() && 
           ...
           form.phone.trim() && 
           form.address.trim() &&
           form.capacity && // Added capacity validation
    ...
    <div className="container">
      <div className="form-layout">
        <div className="form-info">
          <h1>Register as Feeder</h1>
          <p>Join our community of food donors and help reduce waste while serving those in need.</p>
          <ul>
            <li>Share surplus food with local NGOs</li>
            <li>Track your impact on the community</li>
            <li>Connect with verified organizations</li>
            <li>Contribute to food security</li>
          </ul>
        </div>
        
        <div className="form-content">
          <h2>Feeder Registration</h2>
          ...
          <form className="form" onSubmit={handleSubmit}>
            ...
            <label>
              ...
              <textarea 
                ...
                onChange={handleChange} 
                required 
                className={fieldErrors.address ? 'error-field' : ''}
              />
            ...
            <label>
              ...
              <small className="capacity-info">
                Capacity means the total number of meals you can provide to NGOs in a day.
              </small>
            </label>
